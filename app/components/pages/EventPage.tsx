  ...
  return (
    <div className="relative bg-[#0a0a0a]">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        {/* Poster section */}
        <div className="relative z-[2] w-full md:max-w-lg mx-auto h-dvh mt-0 md:h-[calc(100vh-4rem)] md:mt-16 overflow-hidden">
        {/* Background image */}
        <Image
          src={event.poster}
          alt={title}
        ...
        {/* Content overlay */}
        <div className="absolute inset-0 flex flex-col px-4 md:px-12 pt-20 pb-0 md:pt-4 md:pb-4">
    ...
    {/* RSVP List — for upcoming events with RSVP */}
      {showRsvp && (
        <div className="w-full md:max-w-lg mx-auto px-4 md:px-12 py-12 border-t border-[#222]">
          <h2
      ...
      {showRetrospective && (
        <>
          ...
          <div className="hidden md:block w-full pt-24">
            <div className="flex items-center gap-6 max-w-lg mx-auto px-4 md:px-12">
          ...
          <div className="md:hidden w-full max-w-lg mx-auto px-4 md:px-12 py-12">
          ...
          {retrospective && (
            <div className="w-full md:max-w-lg mx-auto px-4 md:px-12 pt-8 md:pt-12 border-t border-[#222] md:border-t-0">
              <h2
                className="text-lg text-[#f5f5f0]/70 tracking-[0.2em] mb-6"
                style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif', fontWeight: 400 }}
              >
          ...
          {event.retrospectivePhotos && event.retrospectivePhotos.length > 0 && (
            <>
              ...
              <div className="w-full md:max-w-6xl mx-auto px-4 md:px-12 mt-12">
                <div className="flex items-center gap-4 mb-8">
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#c9a227]/20 to-transparent" />
                  <p className="text-[10px] tracking-[0.25em] text-[#c9a227]/40 shrink-0">
                    {t('Glimpses', '掠影')}
              ...
              <div className="w-full md:max-w-6xl mx-auto px-4 md:px-12 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
      ...
      {showModal && (
        <div
          className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center px-4 md:px-12"
