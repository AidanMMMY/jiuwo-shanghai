  ...
  return (
    <>
      <HeroCarousel
        ...
        intro={site.intro}
        specialEvent={site.specialEvent?.enabled ? { hero: isZh ? site.specialEvent.hero : site.specialEvent.heroEn, hostName: site.specialEvent.hostName, href: isZh ? '/zh/special' : '/special' } : undefined}
      />
