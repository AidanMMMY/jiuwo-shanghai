...
import { getHeroSlides, getJournalEntriesZh, getJournalEntriesZhDarkroom, getSiteDataZh, getUpcomingEventsZh, getFeaturedZh } from '@/lib/data';
...
export default async function Page() {
  const [site, slides, entries, entriesDarkroom, guestbookEntries, guestbookTotal, upcomingEvents, featured] = await Promise.all([
    getSiteDataZh(),
    getHeroSlides(),
    getJournalEntriesZh(),
