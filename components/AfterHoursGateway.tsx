...
export default function AfterHoursGateway({ isZh = false }: AfterHoursGatewayProps) {
  ...
  return (
    <>
      <section className="weather-normal-section relative overflow-hidden px-4 md:px-12 py-14 md:py-20 bg-[#080808]">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <div className="text-center mb-8 md:mb-10">
            <span className="inline-block text-[10px] tracking-[0.3em] text-[#c9a227]/70 mb-2">
              {isZh ? '过了打烊时间' : 'PAST CLOSING HOURS'}
            </span>
            <h2 className="text-base md:text-lg text-[#f5f5f0] font-light tracking-wide">
